...
| **2. Suporte Operacional** | UK (fuso –4h). SLA P1 ≤10 min. Promete suporte B2C (L1) via chat PT-BR. | EUA (fuso –2h). SLA P1 = 2h comercial. L1 B2C **fica com a CazéTV**. | Low6 |
| **3. Suporte ao Usuário Final** | Low6 se propôs a assumir integralmente o L1 B2C, | CazéTV montará e operará 100% do L1 internamente. LiveLike atua como L2/L3 especialista. | Low6 |
...
| **11. CRM e Notificações** | CRM e Push (XtremePush) operado pela Low6. | Fornece webhooks/triggers. CazéTV assumirá a operação internamente. | Low6 |
...
Portanto, ficou decidido que **faz mais sentido a CazéTV absorver internamente as frentes de suporte L1 e banco de dados de identidade**, garantindo a fundação com a **LiveLike**, que provou ser uma parceira altamente confiável em termos de entrega tecnológica de escalabilidade massiva.
